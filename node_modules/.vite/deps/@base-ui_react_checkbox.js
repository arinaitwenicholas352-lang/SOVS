...
var CheckboxRootContext = React3.createContext(void 0);
...
var CheckboxRoot = React4.forwardRef(function CheckboxRoot2(componentProps, forwardedRef) {
  const {
    checked: checkedProp,
    className,
...
var CheckboxIndicator = React5.forwardRef(function CheckboxIndicator2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const stateAttributesMapping = React5.useMemo(() => ({
