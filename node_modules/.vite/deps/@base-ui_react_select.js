import {
  useLabel,
  useLabelableId
} from "./chunk-F334O5NL.js";
import "./chunk-RFQY72GH.js";
import {
  CompositeList,
  IndexGuessBehavior,
  useCSPContext,
...
} from "./chunk-AFXPV4FQ.js";
import {
  useControlled
} from "./chunk-NTUO3E6F.js";
import {
  ...
  useStore,
  useTypeahead
} from "./chunk-FUZPO62Q.js";
import "./chunk-BLDY3GCB.js";
import {
  useTimeout
} from "./chunk-NS5WE74B.js";
import {
  useValueAsRef
} from "./chunk-MXO7ZC5U.js";
import {
  COMPOSITE_KEYS,
  inertValue
} from "./chunk-2LKLUZB2.js";
import "./chunk-JHNAUBOO.js";
import {
  clamp,
  contains,
  evaluate,
  ...
  ownerDocument,
  rectToClientRect
} from "./chunk-HGE6FZEL.js";
import {
  useValueChanged
} from "./chunk-J3EXDRUN.js";
import {
  visuallyHidden,
  visuallyHiddenInput
} from "./chunk-B626PPC4.js";
import {
  ...
  useTransitionStatus
} from "./chunk-3X5EM74O.js";
import {
  useBaseUiId
} from "./chunk-MWY43WVR.js";
import "./chunk-K5UZNIO3.js";
import {
  require_jsx_runtime
} from "./chunk-C4MI4XMY.js";
import {
  useButton
} from "./chunk-7NNSBJYT.js";
import {
  getWindow,
  useStableCallback
} from "./chunk-ACMFB5CR.js";
import {
  useIsoLayoutEffect
} from "./chunk-53MSWOHF.js";
import {
  ...
  useRefWithInit,
  useRenderElement
} from "./chunk-QUGEBKDC.js";
import {
  mergeProps
} from "./chunk-SN5CKCSN.js";
import {
  require_react
...
function useAnchorPositioning(params) {
  ...
  const [mountSide, setMountSide] = React12.useState(null);
  ...
  const arrowRef = React12.useRef(null);
  ...
  const autoUpdateOptions = React12.useMemo(() => ({
  ...
  const registeredPositionReferenceRef = React12.useRef(null);
  useIsoLayoutEffect(() => {
    if (!mounted) {
      return;
    }
  ...
  const arrowStyles = React12.useMemo(() => {
    var _a2, _b2;
    return {
      position: "absolute",
...
function useAnchoredPopupScrollLock(enabled, touchOpen, positionerElement, referenceElement) {
  const [touchOpenShouldLockScroll, setTouchOpenShouldLockScroll] = React14.useState(false);
  useIsoLayoutEffect(() => {
...
var SelectPositioner = React15.forwardRef(function SelectPositioner2(componentProps, forwardedRef) {
  const {
    anchor,
    positionMethod = "absolute",
    className,
  ...
  const transitionStatus = useStore(store, selectors.transitionStatus);
  const scrollUpArrowRef = React15.useRef(null);
  const scrollDownArrowRef = React15.useRef(null);
  const [controlledAlignItemWithTrigger, setControlledAlignItemWithTrigger] = React15.useState(alignItemWithTrigger);
  ...
  React15.useImperativeHandle(alignItemWithTriggerActiveRef, () => alignItemWithTriggerActive);
  ...
  const prevMapSizeRef = React15.useRef(0);
...
var SelectPopup = React17.forwardRef(function SelectPopup2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
  ...
  const positionerElement = useStore(store, selectors.positionerElement);
  const listElement = useStore(store, selectors.listElement);
  const reachedMaxHeightRef = React17.useRef(false);
  const initialPlacedRef = React17.useRef(false);
  const originalPositionerStylesRef = React17.useRef({});
  ...
  React17.useImperativeHandle(scrollHandlerRef, () => handleScroll, [handleScroll]);
  useOpenChangeComplete({
    open,
    ref: popupRef,
    onComplete() {
  ...
  return (0, import_jsx_runtime6.jsxs)(React17.Fragment, {
...
var SelectList = React18.forwardRef(function SelectList2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
...
var SelectItemContext = React19.createContext(void 0);
if (true) SelectItemContext.displayName = "SelectItemContext";
function useSelectItemContext() {
  const context = React19.useContext(SelectItemContext);
  if (!context) {
...
var SelectItem = React20.memo(React20.forwardRef(function SelectItem2(componentProps, forwardedRef) {
  const {
    render,
    className,
  ...
  const textRef = React20.useRef(null);
  ...
  rootProps.id = void 0;
  const lastKeyRef = React20.useRef(null);
  const pointerTypeRef = React20.useRef("mouse");
  const didPointerDownRef = React20.useRef(false);
  const {
    getButtonProps,
    buttonRef
  } = useButton({
...
var SelectItemIndicator = React21.forwardRef(function SelectItemIndicator2(componentProps, forwardedRef) {
...
var Inner = React21.memo(React21.forwardRef((componentProps, forwardedRef) => {
  const {
    render,
    className,
    style,
...
var SelectItemText = React22.memo(React22.forwardRef(function SelectItemText2(componentProps, forwardedRef) {
  const {
    indexRef,
    textRef,
    selectedByFocus,
  ...
  const localRef = React22.useCallback((node) => {
...
var SelectArrow = React23.forwardRef(function SelectArrow2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
...
var SelectScrollArrow = React24.forwardRef(function SelectScrollArrow2(componentProps, forwardedRef) {
  const {
    render,
    className,
    style,
...
var SelectScrollDownArrow = React25.forwardRef(function SelectScrollDownArrow2(props, forwardedRef) {
...
var SelectScrollUpArrow = React26.forwardRef(function SelectScrollUpArrow2(props, forwardedRef) {
...
var SelectGroupContext = React27.createContext(void 0);
if (true) SelectGroupContext.displayName = "SelectGroupContext";
function useSelectGroupContext() {
  const context = React27.useContext(SelectGroupContext);
  if (context === void 0) {
...
var SelectGroup = React28.forwardRef(function SelectGroup2(componentProps, forwardedRef) {
  const {
    className,
    render,
    style,
  ...
  const [labelId, setLabelId] = React28.useState();
...
var SelectGroupLabel = React29.forwardRef(function SelectGroupLabel2(componentProps, forwardedRef) {
  const {
    className,
    render,
    id: idProp,
...
var Separator = React30.forwardRef(function SeparatorComponent(componentProps, forwardedRef) {
  const {
    className,
    render,
